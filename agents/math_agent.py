...
TOOLS = [
    {
        ...
        "function": {
            "name": "solve_problem",
            "description": "Save the structured solution to a math problem.",
            "parameters": {
                "type": "object",
                "properties": {
                    "problem": {"type": "string"},
                ...
                "required": ["problem", "steps", "answer", "explanation"]
            }
        }
    }
]
...
def run_agent(query, on_step=None):
    ...
    system_prompt = """You are an expert math tutor with memory of the full conversation.
- Solve any math problem using solve_problem
- For follow-ups like 'explain step 2' use earlier context
- Show all steps clearly
- Cover all types: arithmetic, algebra, geometry, calculus, statistics"""
